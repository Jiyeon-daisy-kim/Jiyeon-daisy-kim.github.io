...
Scorcher!의 23초 색보정 발췌 영상과 사용자가 제공한 Instagram 링크를 추가했습니다. 상영 및 수상 이력은 제공되지 않아 표시하지 않습니다. 영상과 하단 링크에 좌우 12~32px 추가 여백을 적용했습니다. 각 HTML에서 공통 메뉴 스크립트의 버전 쿼리를 갱신하여 브라우저가 이전 메뉴를 재사용하지 않도록 했고, Haenam Cabbage의 중복 메뉴 스크립트를 제거했습니다.
